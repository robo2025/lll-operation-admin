...
export const getRouterData = (app) => {
  const routerData = {
    ...
    '/goods/list': {
      component: dynamicWrapper(app, ['rule'], () => import('../routes/GoodsManager')),
    },
    '/:goods/list/detail': {
      component: dynamicWrapper(app, ['rule'], () => import('../routes/GoodDetail/GoodDetail')),
      name: '商品详情页',
    },
    '/product/list': {
    ...
    '/:product/list/new': {
      component: dynamicWrapper(app, ['rule', 'product'], () => import('../routes/NewProduct/NewProduct')),
      name: '新建产品信息',
    },
    '/:product/list/modify': {
      component: dynamicWrapper(app, ['rule', 'product', 'catalog'], () => import('../routes/NewProduct/ModifyProduct')),
      name: '修改产品信息',
    },
    '/product/menu': {
